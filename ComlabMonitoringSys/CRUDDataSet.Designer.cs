...
namespace ComlabMonitoringSys {
    ...
    public partial class CRUDDataSet : global::System.Data.DataSet {
        ...
        public partial class UserSDataTable : global::System.Data.TypedTableBase<UserSRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserSRow AddUserSRow(string UserID, string Password, string Email, string Role) {
...
namespace ComlabMonitoringSys.CRUDDataSetTableAdapters {
    ...
    public partial class UserSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserS] WHERE (([UserID] = @Original_UserID) AND ([Password] = " +
                ...
                "Original_Email)) AND ([Role] = @Original_Role))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserS] ([UserID], [Password], [Email], [Role]) VALUES (@UserID" +
                ", @Password, @Email, @Role);\r\nSELECT UserID, Password, Email, Role FROM UserS WH" +
                "ERE (UserID = @UserID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserS] SET [UserID] = @UserID, [Password] = @Password, [Email] = @Email, [Role] = @Role WHERE (([UserID] = @Original_UserID) AND ([Password] = @Original_Password) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([Role] = @Original_Role));
SELECT UserID, Password, Email, Role FROM UserS WHERE (UserID = @UserID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ComlabMonitoringSys.Properties.Settings.Default.CRUDConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, Password, Email, Role FROM dbo.UserS";
        ...
        public virtual int Fill(CRUDDataSet.UserSDataTable dataTable) {
        ...
        public virtual CRUDDataSet.UserSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CRUDDataSet.UserSDataTable dataTable = new CRUDDataSet.UserSDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CRUDDataSet.UserSDataTable dataTable) {
        ...
        public virtual int Delete(string Original_UserID, string Original_Password, string Original_Email, string Original_Role) {
        ...
        public virtual int Update(string UserID, string Password, string Email, string Role, string Original_UserID, string Original_Password, string Original_Email, string Original_Role) {
            if ((UserID == null)) {
                throw new global::System.ArgumentNullException("UserID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string Email, string Role, string Original_UserID, string Original_Password, string Original_Email, string Original_Role) {
            return this.Update(Original_UserID, Password, Email, Role, Original_UserID, Original_Password, Original_Email, Original_Role);
        }
    }
